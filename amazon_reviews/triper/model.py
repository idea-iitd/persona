...
class GATPolicy(BaseModel):
    ...
    def __init__(self):
        ...
        self.emb_size = 768
        self.user_nfeats = 1879
        self.prod_nfeats = 1879
        self.pers_nfeats = 1879
        # self.cons_nfeats = 5
        self.edge_nfeats = 8
        # self.var_nfeats = 19
    ...
    def forward(self, inputs, return_attention_weights=None):
        ...
        product_features = product_features.cuda()
        ...
        ##pdb.set_trace()trace()
        edge_features = torch.zeros(persona_prod_edge_ind.shape[1],768).cuda()
        ...
        return x, user_features, product_features, persona_features
